// src/components/highlights/HighlightOverlayLayer.jsx
 ...
 */
const HighlightOverlayLayer = ({ highlights = [], scale = 1, focusedHighlightId = null }) => {
...
export default HighlightOverlayLayer;
