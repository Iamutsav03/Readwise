...
// Moved from src/theme/themes.js into features/themes/.
...
export const THEMES = {
  ...
  'lavender': {
    ...
    textPrimary: '#E0D8F0', textSecondary: '#B0A5CD', textMuted: '#8D84B0',
    accent: '#998AD1', accentHover: '#A89CE0', accentMuted: '#241D3A', accentText: '#1A1530',
    border: '#3D3356', borderStrong: '#4D4366', scrollbar: '#4E4270',
  },
  'sepia': {
  ...
  'paper-white': {
    ...
    textPrimary: '#E8E8E8', textSecondary: '#A8A8A8', textMuted: '#848484',
    accent: '#668ABF', accentHover: '#7B9DCE', accentMuted: '#242D3D', accentText: '#1C1C1C',
    border: '#404040', borderStrong: '#505050', scrollbar: '#5C5C5C',
  },
  'rose-beige': {
